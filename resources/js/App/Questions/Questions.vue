...
const data = [
	{
		title:'Какие виды доставки у вас есть?',
		content:'- Польша InPost - 20 zl<br/>' +
						'- Европа - 20$<br/>' +
						'- Доставка по другим континентам мира рассчитывается индивидуально.'
	},
	{
		title:'Какие виды оплаты возможны?',
		content:'- Blik чек / Blik перевод<br/>' +
				'- Криптовалюта<br/>' +
				'- PayPal<br/>' +
				'- IBAN.'
	},
